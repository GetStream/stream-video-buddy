...
async function openChat(page) {
  await page.click(`${controlButtonSelector}--icon-chat`);
}
...
async function enableCamera(page) {
  await clickIfVisible(page, `${controlButtonSelector}--icon-camera-off`);
}

async function disableCamera(page) {
  await clickIfVisible(page, `${controlButtonSelector}--icon-camera`);
}

async function enableMicrophone(page) {
  await clickIfVisible(page, `${controlButtonSelector}--icon-mic-off`);
}

async function disableMicrophone(page) {
  await clickIfVisible(page, `${controlButtonSelector}--icon-mic`);
}
